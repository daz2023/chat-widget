...
(function() {
    ...
    const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            ${config.branding.poweredBy.show ? `<div class="chat-footer">
    ...
    function showTypingIndicator() {
        ...
        console.log('config.typingIndicator:', config.typingIndicator);
        
        // Check if typing indicator is enabled
        if (!config.typingIndicator || !config.typingIndicator.enabled) {
            console.log('Typing indicator disabled or not configured');
            return null;
        }
        ...
        console.log('Appending typing indicator to messages container');
        messagesContainer.appendChild(typingDiv);
        messagesContainer.scrollTop = messagesContainer.scrollHeight;
        
        console.log('Typing indicator element:', typingDiv);
        console.log('Messages container children:', messagesContainer.children);
    ...
    function hideTypingIndicator() {
        ...
        if (typingIndicator) {
            console.log('Found typing indicator, removing it');
